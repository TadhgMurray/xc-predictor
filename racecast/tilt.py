...
#   gives h = -2.1 -- a course making an athlete FASTER the harder it is, which
#   would invert the sign of every cell they touch. These are guard rails
#   against extrapolation, not model features.
