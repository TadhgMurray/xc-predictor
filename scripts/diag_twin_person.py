...
★ THIS IS NOT A DEDUP FAILURE. IT IS AN IDENTITY FAILURE UPSTREAM OF DEDUP,
  ...
  defeats it:
    ...
    1. THE person_id DIFFERS. The tfrrs copy was attached to somebody else,
       so `tw.person_id = r.person_id` never matches and the twin survives as
       a second, separately-pooled athlete.
